...
public class WinRegistry {
	...
	static {
		...
		try {
			try {
				// In Java 11, the handles within WindowsPreferences were changed from int to long. 
				// This change was made here in OpenJDK11. You'll have to change the method signatures to make this code run in a Java 11+ environment
